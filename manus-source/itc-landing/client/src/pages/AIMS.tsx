    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <main className="flex flex-1 flex-col px-6 md:px-16 lg:px-24">
          ...
          <div className="mb-16 pt-8 text-center max-w-4xl mx-auto w-full">
            ...
            <p className="font-rajdhani text-base md:text-lg text-white/60 max-w-2xl mx-auto leading-relaxed">
              Detect up to 18,000 organic compounds per sample in 48 hours at under $250 — with no equivalent anywhere in the market. Developed by Dr. Paul Westlund at C.E.C. Innovations. Marketed and distributed in the US by DASCO, Inc.
            </p>
            ...
            <div className="relative">
              ...
              <div className="relative grid md:grid-cols-2 gap-8 p-8 bg-black/50 backdrop-blur-sm border border-white/10 rounded-xl">
                ...
                <div className="flex flex-col gap-3 justify-center">
                  <a
                    href="mailto:info@dascoinc.com?subject=AIMS Panel Inquiry"
        ...
        <footer className="p-6 text-center text-sm text-white/40 md:p-10">
          &copy; {new Date().getFullYear()} Inception Technology Company. AIMS technology developed by C.E.C. Innovations. Marketed and distributed by DASCO, Inc. All rights reserved.
        </footer>
      </div>
    </div>
  );
